...
-- DropForeignKey
ALTER TABLE "AuditLog" DROP CONSTRAINT "AuditLog_reservationId_fkey";

-- DropForeignKey
ALTER TABLE "AuditLog" DROP CONSTRAINT "AuditLog_roomId_fkey";
...
-- DropForeignKey
ALTER TABLE "BlockedSlot" DROP CONSTRAINT "BlockedSlot_roomId_fkey";

...
const menuItems = [
  { href: "/admin/dashboard", label: "Dashboard", icon: FiPieChart },
  { href: "/admin/pengajuan", label: "Kelola Pengajuan", icon: FiFileText },
  { href: "/admin/ruangan", label: "Kelola Ruangan", icon: FiBox },
  { href: "/admin/jadwal", label: "Kelola Jadwal", icon: FiCalendar },
  { href: "/admin/laporan", label: "Laporan", icon: FiTrendingUp },
];
